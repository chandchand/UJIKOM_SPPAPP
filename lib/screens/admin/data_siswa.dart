...
import 'package:spp_app/screens/admin/naik_kelas.dart';
                    ...
                    onPressed: () {
                      Navigator.push(
                          ...
                          new MaterialPageRoute(
                              builder: (BuildContext context) => new X()));
                    }),
                FlatButton(
                    child: Column(
                      children: [
                    ...
                    onPressed: () {
                      Navigator.push(
                          context,
                          new MaterialPageRoute(
                              builder: (BuildContext context) => new XI()));
                    }),
                FlatButton(
                    child: Column(
                      children: [
                    ...
                    onPressed: () {
                      Navigator.push(
                          context,
                          new MaterialPageRoute(
                              builder: (BuildContext context) => new XII()));
                    })
              ],
            ),
          ),
                ...
                children: [
                  Container(
                    ...
                    child: FlatButton(
                      ...
                      onPressed: () => Navigator.of(context).push(
                          MaterialPageRoute(
                              builder: (BuildContext context) => Tambah())),
                      child: Padding(
                  ...
                  Container(
                    ...
                    child: FlatButton(
                      ...
                      onPressed: () => Navigator.of(context).push(
                          MaterialPageRoute(
                              builder: (BuildContext context) => NaikKelas())),
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Row(
                          children: [
