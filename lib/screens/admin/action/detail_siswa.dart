...
class DetailSiswa extends StatefulWidget {
  ...
  DetailSiswa({Key key, this.id_siswa, this.nis_siswa, this.nama_siswa})
      : super(key: key);
  // List list;
  // int index;
                ...
                Row(
                  children: [
                    IconButton(
                        onPressed: () =>
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (BuildContext context) => EditSiswa(
                                      id_siswa: widget.id_siswa,
                                      nis_siswa: widget.nis_siswa,
                                      nama: '$nama',
                                      alamat: '$alamat',
                                      jenkel: '$jenkel',
                                      kelas: '$kelas',
