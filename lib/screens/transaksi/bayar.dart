...
class _BayarState extends State<Bayar> {
  ...
  void ambiltagihan() async {
    Uri uritagihan = Uri.parse("http://192.168.1.10/spp_app/get_tagihan.php");
  ...
  void ambildatasiswa() async {
    Uri uriDetail = Uri.parse("http://192.168.1.10/spp_app/bayar.php");
  ...
  void bayarspp() async {
    if (nominal.text == "") {
      ...
      Uri pembayaran =
          Uri.parse("http://192.168.1.10/spp_app/pembayaran_spp.php");
